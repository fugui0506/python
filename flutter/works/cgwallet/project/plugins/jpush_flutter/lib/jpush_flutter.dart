...
class JPush {
  ...
  static final JPush _instance =
      JPush.private(const MethodChannel('jpush'));
  ...
  void setChannelAndSound({
    ...
    print("${flutterLog}setChannelAndSound:");
  ...
  void setUnShowAtTheForeground({bool unShow = false}) {
    ...
    print("${flutterLog}setUnShowAtTheForeground:");
  ...
  void setLinkMergeEnable({bool enable = true}) {
    ...
    print("${flutterLog}setLinkMergeEnable:");
  ...
  void setGeofenceEnable({bool enable = true}) {
    ...
    print("${flutterLog}setGeofenceEnable:");
  ...
  void setSmartPushEnable({bool enable = true}) {
    ...
    print("${flutterLog}setSmartPushEnable:");
  ...
  void setCollectControl({
    ...
    print("${flutterLog}setCollectControl:");
  ...
  void pageEnterTo(String pageName) {
    print("${flutterLog}pageEnterTo:$pageName");
    if (!Platform.isIOS) {
      return;
    }
  ...
  void pageLeave(String pageName) {
    print("${flutterLog}pageLeave:$pageName");
    if (!Platform.isIOS) {
      return;
    }
  ...
  void testCountryCode(String code) {
    print("${flutterLog}testCountryCode:$code");
  ...
  Future clearLocalNotifications() async {
    ...
    print("${flutterLog}clearLocalNotifications:");
  ...
  Future<Map<dynamic, dynamic>> getLaunchAppNotification() async {
    print("${flutterLog}getLaunchAppNotification:");
